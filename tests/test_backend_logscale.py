...
def test_crowdstrikelogscale_and_expression_startswith(
...
def test_crowdstrikelogscale_or_and_expression_with_dots(
    logscale_backend: LogScaleBackend,
):
    assert (
        logscale_backend.convert(
...
def test_crowdstrikelogscale_regex_query_special_characters(
    logscale_backend: LogScaleBackend,
):
    assert (
        logscale_backend.convert(
...
def test_crowdstrikelogscale_field_name_with_whitespace(
    logscale_backend: LogScaleBackend,
):
    assert (
        logscale_backend.convert(
